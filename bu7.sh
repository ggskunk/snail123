...
while true; do
    ...
    echo "Çalıştırılan komut: ./vanitysearch -gpuId 7 -start $random_start -range 42 1MVDYgVaSN6iKKEsbzRUAYFrYJadLYZvvZ -o output.txt"

    # VanitySearch çalıştır
    ./vanitysearch -gpuId 7 -o output.txt -start $random_start -range 42 1MVDYgVaSN6iKKEsbzRUAYFrYJadLYZvvZ
